...
-- ============================================================
-- 1. Add buyer role enum value + is_buyer_role() helper
-- ============================================================
...
-- ============================================================
-- 2. Create buyer_po_access table
-- ============================================================
...
-- ============================================================
-- 3. Add buyer_company_name to profiles
-- ============================================================
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS buyer_company_name text;

-- ============================================================
-- 4. Buyer RLS policies on production tables
-- ============================================================
...
-- ============================================================
-- 5. Create buyer_factory_memberships table (multi-workspace)
-- ============================================================
...
-- ============================================================
-- 6. Create buyer_workspace_prefs table
-- ============================================================
...
-- ============================================================
-- 7. Backfill existing buyers into memberships (safe no-op if no data)
-- ============================================================
...
-- ============================================================
-- 8. Membership count helper function
-- ============================================================
